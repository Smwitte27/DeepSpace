package frc.team2606.robot.IntakeStateInfo;

import frc.team2606.lib.util.TimeDelayedBoolean;

//import frc.team2606.frc2018.states.SuperstructureConstants;
//import frc.team2606.frc2018.states.TimedLEDState;
//import frc.team2606.lib.util.TimeDelayedBoolean;
...
public class IntakeStateMachine {
    ...
    private synchronized void getKeepingCubeCommandedState(IntakeState currentState, IntakeState commandedState, double timestamp) {
        ...
        if (currentlySeeCube) {
            ...
            //commandedState.ledState = currentState.kickStandEngaged ? TimedLEDState.StaticLEDState.kHasCube : TimedLEDState.BlinkingLEDState.kHasCube;
    ...
    private boolean mustStayClosed(IntakeState state) {
        //return state.wristSetpoint < SuperstructureConstants.kAlwaysNeedsJawClampMinAngle || state.wristAngle < SuperstructureConstants.kAlwaysNeedsJawClampMinAngle;
        return false;
    }
}
